...
The Streamlit app satisfies all assignment requirements:
...
Notes for Evaluation and Submission



• All models are trained using sklearn and XGBoost

• No model is trained inside Streamlit

• Streamlit uses only saved models and scaler

• Single Jupyter Notebook is used for training and evaluation
